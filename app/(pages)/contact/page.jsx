...
function Contact() {
  const [send,setSend]=useState(false)
    return (send?(
<div class="py-20 md:py-[120px] relative">
                            ...
                            <div class="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
                                ...
                                <div class="lg:mt-0 lg:flex-shrink-0">
                                    <div class="mt-12 inline-flex rounded-md shadow">
                                        <button type="button" onClick={()=>setSend(false)} class="py-4 px-6  bg-indigo-600 hover:bg-indigo-700 focus:ring-indigo-500 focus:ring-offset-indigo-200 text-black w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-lg ">
                                           {"Ok"}
                                        </button>
                                    </div>
                                </div>
